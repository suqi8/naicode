...
impl ChatWidget {
    ...
    pub(super) fn marketplace_remove_loading_popup_params(
        ...
        SelectionViewParams {
            ...
            items: vec![SelectionItem {
                ...
                description: Some("应用市场移除完成后会更新。".to_string()),
                is_disabled: true,
                ..Default::default()
            }],
            ..Default::default()
    ...
    pub(super) fn marketplace_upgrade_loading_popup_params(
        ...
        let loading_text = marketplace_name
            .map(|name| format!("正在升级 {name} 应用市场..."))
            .unwrap_or_else(|| "正在升级应用市场...".to_string());
        SelectionViewParams {
            view_id: Some(PLUGINS_SELECTION_VIEW_ID),
            header: Box::new(DelayedLoadingHeader::new(
                self.frame_requester.clone(),
            ...
            items: vec![SelectionItem {
                name: loading_text,
                description: Some("应用市场升级完成后会更新。".to_string()),
                is_disabled: true,
                ..Default::default()
            }],
            ..Default::default()
    ...
    pub(super) fn plugin_detail_loading_popup_params(
        ...
        SelectionViewParams {
            ...
            items: vec![SelectionItem {
                ...
                description: Some("插件详情加载完成后会更新。".to_string()),
                is_disabled: true,
                ..Default::default()
            }],
            ..Default::default()
    ...
    pub(super) fn plugin_install_loading_popup_params(
        ...
        SelectionViewParams {
            ...
            items: vec![SelectionItem {
                ...
                description: Some("插件安装完成后会更新。".to_string()),
                is_disabled: true,
                ..Default::default()
            }],
            ..Default::default()
    ...
    pub(super) fn plugin_uninstall_loading_popup_params(
        ...
        SelectionViewParams {
            ...
            items: vec![SelectionItem {
                ...
                description: Some("插件移除完成后会更新。".to_string()),
                is_disabled: true,
                ..Default::default()
            }],
            ..Default::default()
    ...
    pub(super) fn marketplace_add_error_popup_params(&self) -> SelectionViewParams {
        ...
        let mut items = vec![
            SelectionItem {
                name: "添加应用市场失败".to_string(),
                description: Some("无法从所提供的来源添加应用市场。".to_string()),
                is_disabled: true,
                ..Default::default()
            },
            SelectionItem {
                name: "重试".to_string(),
                description: Some("输入应用市场来源。".to_string()),
                selected_description: Some("输入应用市场来源。".to_string()),
    ...
    pub(super) fn marketplace_remove_error_popup_params(
        ...
        let mut items = vec![
            SelectionItem {
                name: "移除应用市场失败".to_string(),
                description: Some("无法移除所选的应用市场。".to_string()),
                is_disabled: true,
                ..Default::default()
            },
            SelectionItem {
    ...
    fn plugin_selection_items<'a>(
        ...
        for (marketplace, plugin, display_name) in plugin_entries {
            ...
            let selected_description = if can_toggle_plugin {
                ...
                if can_view_details {
                    format!(
                        "{selected_status_label}   按 Space {toggle_action}；按 Enter 查看详情。"
                    )
                } else {
                    format!("{selected_status_label}   按 Space {toggle_action}。")
                }
                ...
                format!("{selected_status_label}   远程插件详情尚不可用。")
            };
...
fn plugins_popup_hint_line(
    ...
    match (can_remove_marketplace, can_upgrade_marketplace) {
        ...
        (true, false) => {
            Line::from("ctrl + r 移除 · space 开关 · ←/→ 切换标签 · enter 详情 · esc 关闭")
        }
        (false, true) => {
            Line::from("ctrl + u 升级 · space 开关 · ←/→ 切换标签 · enter 详情 · esc 关闭")
        }
        (false, false) => {
            Line::from("space 启用/禁用 · ←/→ 选择应用市场 · enter 查看详情 · esc 关闭")
        }
    }
}
